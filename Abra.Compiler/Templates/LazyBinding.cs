...
namespace Abra.Compiler.Templates
{
    ...
    #line 1 "C:\Users\ben\Development\abra-ioc\Abra.Compiler\Templates\LazyBinding.tt"
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "11.0.0.0")]
    public partial class LazyBinding : LazyBindingBase
    {
#line hidden
        /// <summary>
        ...
        public override object Get()
        {
            ...
            #line default
            #line hidden
            this.Write(") delegateBinding.Get());\r\n        }\r\n\r\n        public override void InjectProper" +
                    "ties(object obj)\r\n        {\r\n            throw new NotSupportedException(\"Lazy b" +
                    "indings do not support property injection.\");\r\n        }\r\n    }\r\n}");
            return this.GenerationEnvironment.ToString();
        }
        
        #line 1 "C:\Users\ben\Development\abra-ioc\Abra.Compiler\Templates\LazyBinding.tt"

private global::Abra.Compiler.Generators.LazyBindingGenerator _clsField;

/// <summary>
/// Access the cls parameter of the template.
/// </summary>
private global::Abra.Compiler.Generators.LazyBindingGenerator cls
{
    get
    {
...
{
    if ((typeof(global::Abra.Compiler.Generators.LazyBindingGenerator).IsAssignableFrom(this.Session["cls"].GetType()) == false))
    {
        this.Error("The type \'Abra.Compiler.Generators.LazyBindingGenerator\' of the parameter \'cls\' d" +
                "id not match the type of the data passed to the template.");
    }
    else
    {
        this._clsField = ((global::Abra.Compiler.Generators.LazyBindingGenerator)(this.Session["cls"]));
...
if ((clsValueAcquired == false))
{
    ...
    if ((data != null))
    {
        if ((typeof(global::Abra.Compiler.Generators.LazyBindingGenerator).IsAssignableFrom(data.GetType()) == false))
        {
            this.Error("The type \'Abra.Compiler.Generators.LazyBindingGenerator\' of the parameter \'cls\' d" +
                    "id not match the type of the data passed to the template.");
        }
        ...
        {
            this._clsField = ((global::Abra.Compiler.Generators.LazyBindingGenerator)(data));
        }
    }
}
